            ...
            {isExpanded && (
                <div className="space-y-6">
                    ...
                    <div>
                        ...
                        <Input type="text" value="Fair Launch" readOnly className="bg-muted-foreground/10" />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <Input type="text" placeholder="0.02" />
                            <p className="text-xs text-muted-foreground mt-1">
                    ...
                    <div className="border border-gray-200 rounded-lg">
                        <div className={`flex ${schedule ? 'bg-gray-50 border-b border-gray-200 rounded-t-lg mb-2' : 'bg-white rounded-lg'} p-3 items-center justify-between`}>
                            ...
                            <button
                                ...
                                className={`
                                    ...
                                    ${schedule ? 'bg-black' : 'bg-gray-200'}
                                `}
                            >
                                <span
                                    className={`
                                        inline-block h-4 w-4 transform rounded-full bg-white transition duration-200 ease-in-out
                                        ${schedule ? 'translate-x-6' : 'translate-x-1'}
                                    `}
                                />
                            </button>
                        </div>
