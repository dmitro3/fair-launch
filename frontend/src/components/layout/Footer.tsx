...
export const Footer = () => {
    ...
    return(
        <div className="w-full border-t border-gray-200 pt-6 mt-20">
            <div className="p-4 flex flex-col md:flex-row justify-between items-center gap-5 md:items-end lg:container mx-auto">
