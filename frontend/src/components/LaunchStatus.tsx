...
export function LaunchStatus() {
    ...
    return (
        <Card className="p-4 md:p-6 mb-6 shadow-none border border-gray-200">
            ...
            <div className="bg-gradient-to-r from-green-50 to-white rounded-lg p-3 md:p-4 border border-green-200">
                ...
                <div className="flex md:flex-row flex-col md:items-center md:justify-between">
                    <div className="flex md:flex-row flex-col items-start md:items-center md:gap-4">
                        ...
                        <div className="md:w-10 md:h-0.5 w-0.5 h-5 ml-1 md:ml-0 rounded-full bg-green-500"></div>
                        <div className="flex items-center gap-2">
                        ...
                        <div className="ml-5 text-center hidden md:block">
